...
Func _On_Drop($hDrop)
	...
	For $i = 1 To $aDrop_List[0]
		...
		If $JpgCheck = ".jpg" Then GUICtrlSetData($idListFiles, $aDrop_List[$i]) ;Dumps dropped files to listview
	...
	For $i = 1 To $aList[0][0] ;Dumps found files to listview
		...
		If $JpgCheck = ".jpg" Then GUICtrlSetData($idListFiles, $aList[$i][0]) ;Dumps dropped files to listview
	Next
